...
const unsigned char dino_bitmap [] PROGMEM = {
  0x21, 0xFE, 0x23, 0x1F, 0x23, 0x1F, 0x03, 
  0x1F, 0x21, 0xF0, 0x01, 0xFC, 0x83, 0xE7, 
  0x87, 0xE0, 0xCF, 0xFC, 0xFF, 0xE0, 0x7F, 
  0xE0, 0x3F, 0xC0, 0x1F, 0x80, 0x09, 0x00, xxx
  0x09, 0x00, 0x00, 0x00
};

const unsigned char dino_right_foot_bitmap [] PROGMEM = {
  0x01, 0xFE, 0x03, 0xFF, 0x03, 0xBF, 0x03, 0xFF, 0x01, 
  0xF0, 0x81, 0xFE, 0x83, 0xE0, 0xC7, 0xFC, 0xEF, 0xE8, 
  0x7F, 0xE0, 0x3F, 0xE0, 0x1F, 0xC0, 0x1F, 0x80, 0x0B, 
  0x00, 0x09, 0x80, 0x0C, 0x00
};

const unsigned char dino_left_foot_bitmap [] PROGMEM = {
  0x01, 0xFE, 0x03, 0xFF, 0x03, 0x7F, 0x03, 0xFF, 0x01, 
  0xF0, 0x01, 0xFE, 0x83, 0xE0, 0x87, 0xFC, 0xCF, 0xE4, 
  0xFF, 0xE0, 0x7F, 0xE0, 0x3F, 0xC0, 0x1F, 0x80, 0x19, 
  0x00, 0x0D, 0x00, 0x01, 0x80
};

const unsigned char cactus_bitmap [] PROGMEM = {
  0x18, 0x18, 0x18, 0x38, 0x3C, 0x7C, 0x7C, 0x7C, 
  0x7C, 0x78, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18
};

const unsigned char dino_crouch_bitmap [] PROGMEM = {
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
  0x00, 0x00, 0xFE, 0x01, 0xFF, 0x07, 0xFF, 0x0F, 0xFD, 
  0x1F, 0xF5, 0x1F, 0xF5, 0x0F, 0xE5, 0x06, 0x67, 0x02, 
  0x20, 0x02, 0x20, 0x03, 0x30
};

const unsigned char dino_crouch_right_foot_bitmap [] PROGMEM = {
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFE, 
  0xFE, 0x83, 0xFF, 0xDF, 0xC7, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 
  0x7F, 0xFF, 0xFF, 0x3F, 0xFF, 0x70, 0x1F, 0xFE, 0x3E, 0x03, 
  0x23, 0x00, 0x02, 0x31, 0x00, 0x03, 0x00, 0x00
};

const unsigned char dino_crouch_left_foot_bitmap [] PROGMEM = {
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0xFE, 
  0xFE, 0xE3, 0xFF, 0xEF, 0xFF, 0xFF, 0xFF, 0x7F, 0xFF, 0xFF, 
  0x3F, 0xFF, 0xFF, 0x1F, 0xFF, 0x70, 0x0F, 0xFE, 0x3E, 0x02, 
  0x63, 0x00, 0x03, 0x20, 0x00, 0x00, 0x30, 0x00
};

const unsigned char bird_up_bitmap [] PROGMEM = {
  0x00, 0x40, 0x00, 0x60, 0x0C, 0x70, 0x1E, 0x78, 
  0x3F, 0xFE, 0x03, 0xF8, 0x01, 0xFE, 0x00, 0x00, 
...
const unsigned char bird_down_bitmap [] PROGMEM = {
  ...
  0x3F, 0xFE, 0x03, 0xF8, 0x01, 0xFE, 0x00, 0x60, 
